...
namespace JoeEngine {
    ...
    void JEShadowShader::CreateGraphicsPipeline(VkDevice device, VkShaderModule vertShaderModule, VkShaderModule fragShaderModule,
        ...
        pipelineLayoutInfo.pSetLayouts = &m_descriptorSetLayouts[1];
        
        // Set up push constant range
        VkPushConstantRange pushConstantRange = {};
        pushConstantRange.stageFlags = VK_SHADER_STAGE_VERTEX_BIT;
        pushConstantRange.offset = 0;
        pushConstantRange.size = sizeof(glm::mat4) + sizeof(uint32_t) * 4;
    ...
    void JEShadowShader::BindPushConstants_InstancedData(VkCommandBuffer commandBuffer, const std::array<uint32_t, 4>& instancedData) const {
    ...
    void JEDeferredGeometryShader::CreateGraphicsPipeline(VkDevice device, VkShaderModule vertShaderModule, VkShaderModule fragShaderModule,
        VkExtent2D frameExtent, VkRenderPass renderPass, const MaterialComponent& materialComponent) {
        // Shader stages
        VkPipelineShaderStageCreateInfo vertShaderStageInfo = {};
        vertShaderStageInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
        ...
        std::vector<VkPipelineColorBlendAttachmentState> colorBlendAttachments;
        // TODO: connect the '2' to the number of G-buffer targets somehow
    ...
    void JEDeferredGeometryShader::BindPushConstants_InstancedData(VkCommandBuffer commandBuffer, const std::array<uint32_t, 4>& instancedData) const {
        vkCmdPushConstants(commandBuffer, m_pipelineLayout, VK_SHADER_STAGE_VERTEX_BIT, sizeof(JE_PushConst_ViewProj), sizeof(uint32_t) * 4, instancedData.data());
    }
    ...
    void JEForwardShader::CreateGraphicsPipeline(VkDevice device, VkShaderModule vertShaderModule, VkShaderModule fragShaderModule,
        VkExtent2D frameExtent, VkRenderPass renderPass, const MaterialComponent& materialComponent) {
        // Shader stages
        VkPipelineShaderStageCreateInfo vertShaderStageInfo = {};
        vertShaderStageInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
        ...
        rasterizer.polygonMode = VK_POLYGON_MODE_FILL;
        rasterizer.lineWidth = 1.0f;
        rasterizer.cullMode = VK_CULL_MODE_NONE; // TODO: make sure this is right
        rasterizer.frontFace = VK_FRONT_FACE_COUNTER_CLOCKWISE;
        rasterizer.depthBiasEnable = VK_FALSE;
        rasterizer.depthBiasConstantFactor = 0.0f;
        rasterizer.depthBiasClamp = 0.0f;
    ...
    void JEForwardShader::BindPushConstants_ViewProj(VkCommandBuffer commandBuffer, const glm::mat4& viewProj) const {
        vkCmdPushConstants(commandBuffer, m_pipelineLayout, VK_SHADER_STAGE_VERTEX_BIT, 0, sizeof(JE_PushConst_ViewProj), &viewProj[0][0]);
    }

    void JEForwardShader::BindPushConstants_InstancedData(VkCommandBuffer commandBuffer, const std::array<uint32_t, 4>& instancedData) const {
        vkCmdPushConstants(commandBuffer, m_pipelineLayout, VK_SHADER_STAGE_VERTEX_BIT, sizeof(JE_PushConst_ViewProj), sizeof(uint32_t) * 4, instancedData.data());
    }
    ...
    void JEVulkanForwardShader::CreateGraphicsPipeline(VkDevice device, VkShaderModule vertShaderModule, VkShaderModule fragShaderModule,
    ...
    void JEVulkanForwardShader::CreateDescriptorPool(VkDevice device) {
    ...
    void JEVulkanForwardShader::CreateDescriptorSetLayout(VkDevice device) {
    ...
    void JEVulkanForwardShader::CreateDescriptorSets(VkDevice device, const JETexture& texture) {
    ...
    void JEVulkanForwardShader::CreateUniformBuffers(VkPhysicalDevice physicalDevice, VkDevice device) {
    }

    void JEVulkanForwardShader::UpdateUniformBuffers(VkDevice device) {
    }

    void JEVulkanForwardShader::BindDescriptorSets(VkCommandBuffer commandBuffer) {
        vkCmdBindDescriptorSets(commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, m_pipelineLayout, 0, 1, &m_descriptorSet, 0, nullptr);
    }

    void JEVulkanForwardShader::BindPushConstants_ViewProj(VkCommandBuffer commandBuffer, const glm::mat4& viewProj) {
        vkCmdPushConstants(commandBuffer, m_pipelineLayout, VK_SHADER_STAGE_VERTEX_BIT, 0, sizeof(JE_PushConst_ViewProj), &viewProj[0][0]);
    }

    void JEVulkanForwardShader::BindPushConstants_ModelMatrix(VkCommandBuffer commandBuffer, const glm::mat4& modelMat) {
    ...
    void JEVulkanFlatShader::Cleanup(VkDevice device) {
        vkDestroyPipelineLayout(device, m_pipelineLayout, nullptr);
        vkDestroyPipeline(device, m_graphicsPipeline, nullptr);
    }

    void JEVulkanFlatShader::CreateGraphicsPipeline(VkDevice device, VkShaderModule vertShaderModule, VkShaderModule fragShaderModule,
    ...
    void JEVulkanFlatShader::BindPushConstants_ViewProj(VkCommandBuffer commandBuffer, const glm::mat4& viewProj) {
        vkCmdPushConstants(commandBuffer, m_pipelineLayout, VK_SHADER_STAGE_VERTEX_BIT, 0, sizeof(JE_PushConst_ViewProj), &viewProj[0][0]);
    }

    void JEVulkanFlatShader::BindPushConstants_ModelMatrix(VkCommandBuffer commandBuffer, const glm::mat4& modelMat) {
        vkCmdPushConstants(commandBuffer, m_pipelineLayout, VK_SHADER_STAGE_VERTEX_BIT, sizeof(JE_PushConst_ViewProj), sizeof(JE_PushConst_ModelMat), &modelMat[0][0]);
    }
