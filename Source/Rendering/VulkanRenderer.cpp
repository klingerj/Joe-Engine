...
namespace JoeEngine {
    ...
    void JEVulkanRenderer::Initialize(JESceneManager* sceneManager, JEEngineInstance* engineInstance) {
        ...
        if constexpr (isDeferred) {
            ...
            m_deferredLightingDescriptorID = m_shaderManager.CreateDescriptor(m_device, m_physicalDevice, m_vulkanSwapChain, temp,
    ...
    void JEVulkanRenderer::DrawMeshComponents(const std::vector<MeshComponent>& meshComponents,
        ...
        if constexpr (isDeferred) {
            ...
            // TODO: fix me, need image index and the right material component index
